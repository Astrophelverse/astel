  ...
  <View style={styles.container}>
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      <View style={styles.header}>
        <Icon name="file-document" size={64} color="#C7C7CC" />
        <Text style={styles.title}>Post Details</Text>
        <Text style={styles.subtitle}>View post information and comments</Text>
      </View>
      <View style={styles.content}>
        <Text style={styles.message}>Post detail features coming soon!</Text>
      </View>
    </ScrollView>
  </View>
);
