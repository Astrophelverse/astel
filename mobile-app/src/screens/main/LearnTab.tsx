  ...
  <View style={styles.container}>
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      <View style={styles.header}>
        <Icon name="school" size={64} color="#C7C7CC" />
        <Text style={styles.title}>Learn & Tutorials</Text>
        <Text style={styles.subtitle}>Educational content and guides</Text>
      </View>
      <View style={styles.content}>
        <Text style={styles.message}>Tutorials and learning content coming soon!</Text>
      </View>
    </ScrollView>
  </View>
);
