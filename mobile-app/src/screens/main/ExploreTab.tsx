  ...
  <View style={styles.container}>
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      <View style={styles.header}>
        <Icon name="compass" size={64} color="#C7C7CC" />
        <Text style={styles.title}>Explore</Text>
        <Text style={styles.subtitle}>Discover new products and users</Text>
      </View>
      <View style={styles.content}>
        <Text style={styles.message}>Explore features coming soon!</Text>
      </View>
    </ScrollView>
  </View>
);
